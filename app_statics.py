...
country_mapping = {
    ...
    "Jamaica": "Jamaica",
    "Burkina Faso e  Brazzaville": "Burkina Faso;Congo",
    "Chile) e Buenos Aires (Argentina": "Chile;Argentina",
    "Honduras) e  Manágua  (Nicarágua": "Honduras;Nicaragua",
    "El Salvador": "Haiti;El Salvador",
    "Vietnã": "Vietnam",
    "Indonésia":"Indonesia",
    "Timor-Leste" : "East Timor",
    "Haitielsalvador" : "El Salvador;Cuba"
}
...
city_mapping = {
    ...
    "Ouagadougou": "Ouagadougou and Brazzaville",
    "Cidade da Guatemala": "Guatemala City",
    "Haia e Amsterdã": "The Hague and Amsterdam",
    "Praga": "Prague",
    "Acra": "Accra",
    "São Salvador": "Port-au-Prince and San Salvador",
